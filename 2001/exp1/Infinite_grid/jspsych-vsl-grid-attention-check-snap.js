...
var jsPsychVslGridAttentionCheckSnap = (function(jspsych) {
  ...
  //    (assuming you want a 20×20 "infinite" grid)
  var nrows_grid = 20;
  var ncols_grid = 20;
  var stimuli_start_row = 3; // same offset as in scene_snap
  var stimuli_start_col = 7; // same offset as in scene_snap
  ...
  //    using the same offset as your 3×3 scenes.
  //    Example if trial.stimuli is a 5×5 array:
